...
module.exports.config = {
	...
	description: "đặt lịch hẹn đến giờ sẽ thông báo lịch hẹn", // Thông tin chi tiết về lệnh
...
//DEFINE PATH
const path = __dirname + '/bot/datlich.json';
...
module.exports.run = async function ({ api, event, args, Users }) {
	...
	// CHECK CHECK CHECK
	if (date[0].split("/").length != 3 || date[1].split(":").length != 3) return api.sendMessage("Bạn phải nhập đúng định dạng NGÀY/THÁNG/NĂM_GIỜ:PHÚT:GIÂY\nVD: datlich iloveyou | 30/02/2022_12:00:00", threadID, messageID);
